...
function renderLogin() {
  ...
  app.innerHTML = `
    <main class="container" style="max-width: 400px; margin-top: 3rem;">
      <h1 style="text-align: center;"><img src="/favicon.svg?v=1.8.3" alt="" style="width:1.2em;height:1.2em;vertical-align:-0.18em;"> EÓN <small style="font-size:.45em;color:var(--pico-muted-color);font-weight:normal;">v1.8.3</small></h1>
...
function renderNuevaPassword() {
  if (!app) return;
  app.innerHTML = `<main class="container" style="max-width:400px;margin-top:3rem;"><h1 style="text-align:center;"><img src="/favicon.svg?v=1.8.1" alt="" style="width:1.2em;height:1.2em;vertical-align:-0.18em;"> EÓN <small style="font-size:.45em;color:var(--pico-muted-color);font-weight:normal;">v1.8.3</small></h1><article><h2>Elegí tu nueva contraseña</h2>
  ...
  app.innerHTML = `
    ...
    <main class="container">
      <header class="eon-header">
        <h1 class="eon-logo"><img src="/favicon.svg?v=1.8.1" alt="" style="width:1.15em;height:1.15em;"> EÓN <small style="font-size:.42em;color:var(--pico-muted-color);font-weight:normal;">v1.8.3</small></h1>
